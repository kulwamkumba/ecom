    ...
    <body>
        <div>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/lenovo.jpg" alt="PINK">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>LENOVO</h3>
                                    <p>Price: Ugx. 5000000/=</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                                        }
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/dell.png" alt="LATITUDE">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Dell Inspiron 15 5000</h3>
                                    <p>Price: Ugx. 3000000/=</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                                        }
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/PROBOOK.PNG" alt="PROBOOK">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Probook 450 G5</h3>
                                    <p>Price: Ugx. 4000000/=</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                                        }
           ...
           <footer class="footer">
               <div class="container">
                <center>
                <p>Copyright &copy <a href="#">Mkumba and Kayondo</a> Store. All Rights Reserved.</p>
